...
public class HookahServerState {
    ...
    public static void load() {
        statePath = FabricLoader.getInstance().getConfigDir().resolve("brewing_state_server_state.json");
    ...
    public static void save() {
        ...
        try {
            ...
            HookahMod.LOGGER.error("Failed to save BrewingStandSmoke server state", e);
        }
    }
